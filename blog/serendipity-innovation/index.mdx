...
I think key is to design them as invitation and not to force it. Workspaces nudging employees to interact might not creating the expected results because we often do not have the option not to engage and remove ourselves.
